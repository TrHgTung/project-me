...
<html lang="en">
  <head>
    ...
    <title>Nov 15th, 2022 - Ash Ketchum won the finale in The Pokémon World Championship</title>
    ...
    <script>
        ...
        function changeBg (){
          ...
          console.log(scrollValue); //need to change on ~186 (= y = 186.**** px)  559.2000122070312
            if(scrollValue > 186.39999389648438 && scrollValue < 559.2000122070312){
              nav01.classList.remove('navbar navbar-expand-md navbar-dark fixed-top bg-dark');
            }else{
              nav01.classList.add('navbar navbar-expand-md navbar-dark fixed-top bg-dark');
            }
        }
  ...
  <body oncontextmenu="return false;">  
   <header>
  <!-- nav bar 01 __id -->
    <nav id="nav01" class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
