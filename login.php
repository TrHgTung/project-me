                ...
                <div class="auth-form__container">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="auth-form__form">
                            <div class="auth-form__group" style="position: relative;">
                                <input type="text" name="user_name" class="input auth-form__input" placeholder="Tên đăng nhập" value="<?php if (isset($_POST['submit'])) { 
                    ...
                    <div class="auth-form__others">
                        ...
                        <div class="auth-form__other">
                            <a href="#"><i style="color:#4267B2" class="icon fa-brands fa-facebook-square"></i></a>
                            <a href="#"><i style="color:#1DA1F2" class="icon fa-brands fa-twitter-square"></i></a>
                            <a href="#"><i style="color:#E1306C" class="icon fa-brands fa-instagram-square"></i></a>
                        </div>
                    </div> 
